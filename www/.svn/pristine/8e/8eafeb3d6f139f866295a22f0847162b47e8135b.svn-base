...
/* TODO wysyłka z ustawionym encryption
                if (empty($config['options']['encryption'])) {
                    ...
                    switch (strtolower($config['options']['encryption'])) {
                        case 'tls': $encryption = Swift_Connection_SMTP::ENC_TLS;
                            break;
                        case 'ssl': $encryption = Swift_Connection_SMTP::ENC_SSL;
                            break;
                    }
                }
*/
        ...
        $transport = Swift_SmtpTransport::newInstance($config['options']['hostname'], $config['options']['port'])
                ->setUsername($config['options']['username'])
                ->setPassword($config['options']['password']);
