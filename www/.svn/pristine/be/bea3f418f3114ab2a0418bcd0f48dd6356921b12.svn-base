...
// TODO: trzeba jakoś zautomatyzowac 
$base_url="http://".$_SERVER['HTTP_HOST'].'/'.trim($_GET['urlbase'], '/');  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/files/medias/image/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../files/medias/image/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../../files/medias/.thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
