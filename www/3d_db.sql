...
(16,	'olicom@olicom.pl',	'Admin',	'Olicom',	'',	'*F2651DAB851BC94D1C6E3F08C9C68E89C0AF4484',	'1270034596',	'1455612823',	190,	NULL,	13,	'Y',	NULL,	NULL,	6),
...
(1,	'administrator_email',	'noreply@comm-hotel.pl',	'Email',	'Adres z którego wysyłane są emaile z systemu',	'',	'text'),
(2,	'administrator_name',	'Admin',	'Nazwa',	'Pole \"Od\" w wysyłanych e-mailach z systemu',	'',	'text'),
(3,	'sending_email',	'noreply@comm-hotel.pl',	'Newsletter email',	'Adres z którego wysyłane są emaile newslettera',	'',	'text'),
...
(6,	'page_name',	'Comm hotel',	'Nazwa strony',	'Używana w mailach',	'',	'text'),
(7,	'page_domain',	'olishop.olicom.com.pl',	'Domena',	'Domena używama m.in. w mailach',	'',	'text'),
(8,	'firm_address',	'<p><strong>Comm Hotel</strong></p>\r\n<p>ul. Bukowska 348/350</p>\r\n<p>60-189 Poznań</p>\r\n<p>&nbsp;</p>\r\n<p>tel: +48 61 868 24 00</p>\r\n<p>tel: +48 61 868&nbsp;10 60</p>\r\n<p>tel: +48&nbsp;501 166 200</p>\r\n<p>fax:&nbsp;+48 61 624&nbsp;11&nbsp;00</p>\r\n<p>&nbsp;</p>\r\n<p>email: <a href=\"mailto:comm@comm-hotel.pl\" rel=\"prettyPhoto\">comm@comm-hotel.pl</a></p>',	'Adres firmy',	'Używany w mailach.',	'',	'textarea'),
...
(9,	84,	'Formularz',	'pl_PL',	'noreply@comm-hotel.pl',	'andrzej@olicom.pl',	'N',	'N'),
(10,	103,	'Formularz Rezerwacji',	'pl_PL',	'noreply@comm-hotel.pl',	'kolbucandrzej@gmail.com',	'N',	'N'),
(11,	125,	'Formularz DE',	'de_DE',	'noreply@comm-hotel.pl',	'andrzej@olicom.pl',	'N',	'N'),
(12,	126,	'Formularz EN',	'en_US',	'noreply@comm-hotel.pl',	'andrzej@olicom.pl',	'N',	'N'),
(13,	127,	'Reservierung',	'de_DE',	'noreply@comm-hotel.pl',	'andrzej@olicom.pl',	'N',	'N'),
(14,	128,	'Reservation',	'en_US',	'noreply@comm-hotel.pl',	'andrzej@olicom.pl',	'N',	'N');
...
(22,	'::1',	1453191410,	'andrzej@olicom.pl',	'test',	'123123',	'test',	'test'),
(23,	'92.43.117.197',	1455002782,	'andrzej@olicom.pl',	'test',	'12312312312',	'test',	'teste'),
(24,	'::1',	1455802599,	'andrzej@olicom.pl',	'tttt',	'123123123',	'test',	'test'),
(25,	'::1',	1455805133,	'andrzej@olicom.pl',	'Andrzej Kołbuc',	'741258963',	'1231',	'213123'),
(26,	'::1',	1455806851,	'andrzej@olicom.pl',	'asdas',	'213123',	'dasd',	'asdas'),
(27,	'::1',	1455807115,	'hubert@olicom.pl',	'hubert test',	'123456789',	'fdsfds',	'fdsdsfds'),
(28,	'::1',	1455807113,	'andrzej@olicom.pl',	'asdas',	'213123',	'dasd',	'asdas');
...
(84,	'contact_form',	1446030553,	1455805357,	'pl_PL',	1),
...
(103,	'contact_form',	1451383379,	1455807259,	'pl_PL',	1),
...
(131,	'galleries',	1453184383,	1453184570,	'pl_PL',	1),
(132,	'page_content',	1453185274,	NULL,	'pl_PL',	1),
(133,	'galleries',	1453185305,	NULL,	'pl_PL',	1),
(134,	'page_content',	1453186340,	NULL,	'pl_PL',	1),
(135,	'galleries',	1453186370,	NULL,	'pl_PL',	1);
...
(2,	'restauracjaGaleria',	'',	131,	'N'),
(3,	'restauracjaGaleriaDE',	'',	133,	'N'),
(4,	'restauracjaGaleriaEN',	'',	135,	'N');
...
(13,	'14531844221569dd5a6f06ca537451318.jpg',	'bigstock-catering-table-set-service-wit-18987848.jpg',	0,	0),
(14,	'14531844231569dd5a7d7db5394180149.jpg',	'bigstock-catering-table-set-service-wit-18987863.jpg',	0,	1),
(15,	'14531844241569dd5a8789c6953738404.jpg',	'bigstock-catering-table-set-service-wit-18988580.jpg',	0,	2),
(16,	'14531844251569dd5a9172d9780157236.jpg',	'bigstock-Fancy-table-set-for-a-wedding--29023898.jpg',	0,	3),
(17,	'14531844251569dd5a9b8ce8274251781.jpg',	'bigstock-Natural-form-foods-Fast-food--13130507.jpg',	0,	4),
(19,	'14531853211569dd92943786789447577.jpg',	'bigstock-catering-table-set-service-wit-18987848.jpg',	0,	0),
(20,	'14531853211569dd929dbbb0860884576.jpg',	'bigstock-catering-table-set-service-wit-18987863.jpg',	0,	1),
(21,	'14531853221569dd92a7ccaa699069170.jpg',	'bigstock-catering-table-set-service-wit-18988580.jpg',	0,	2),
(22,	'14531853231569dd92b23b03232054140.jpg',	'bigstock-Fancy-table-set-for-a-wedding--29023898.jpg',	0,	3),
(23,	'14531853231569dd92bc9d8f131937555.jpg',	'bigstock-Natural-form-foods-Fast-food--13130507.jpg',	0,	4),
(24,	'14531863961569ddd5ca1c11798359663.jpg',	'bigstock-catering-table-set-service-wit-18987848.jpg',	0,	0),
(25,	'14531863971569ddd5d5809f478813704.jpg',	'bigstock-catering-table-set-service-wit-18987863.jpg',	0,	1),
(26,	'14531863971569ddd5df0350438400958.jpg',	'bigstock-catering-table-set-service-wit-18988580.jpg',	0,	2),
(27,	'14531863981569ddd5e8fa88114631411.jpg',	'bigstock-Fancy-table-set-for-a-wedding--29023898.jpg',	0,	3),
(28,	'14531863991569ddd5f57065954767105.jpg',	'bigstock-Natural-form-foods-Fast-food--13130507.jpg',	0,	4);
...
(1,	'Pokój jednoosobowy',	'pl_PL',	'<p>Cena od 209,00 PLN</p>',	'<p>To przestronny pok&oacute;j z szerokim wygodnym ł&oacute;żkiem.</p>\r\n<p>W komfortowych kamiennych łazienkach odnajdą Państwo luksusowe kosmetyki serii Un brin de nature.</p>\r\n<p>Pokoje wyposażone są w telewizory plazmowe z telewizją satelitarną.</p>\r\n<p>W pokojach dostępny jest internet Wi-Fi<strong>,</strong> indywidualnie sterowana klimatyzacja oraz wygodne miejsce do pracy dla gości biznesowych.</p>',	1451257200,	1455021690,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj1.jpg',	'1451314748156814e3c44321413078753.jpg'),
(2,	'Pokój dwuosobowy',	'pl_PL',	'<p>Cena&nbsp;od 219,00 PLN</p>',	'<p>Oferujemy Państwu komfortowe pokoje dwuosobowe z łożem małżeńskim lub dwoma pojedynczymi ł&oacute;żkami.</p>\r\n<p>Pokoje wyposażone są w nowoczesne meble Wenge oraz klimatyzację. W naszych ekskluzywnych, kamiennych łazienkach znajdą Państwo luksusowe kosmetyki serii Un brin de nature.</p>\r\n<p>W każdym pokoju dostępna jest telewizja satelitarna oraz internet Wi-Fi.</p>\r\n<p>Na Państwa życzenie istnieje możliwość dostawki dla dzieci do 16 roku życia.</p>',	1451257200,	1455021674,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj2.jpg',	'1451314979156814f2359fa2066848153.jpg'),
(3,	'Pokój DE LUX',	'pl_PL',	'<p>Cena&nbsp;od 299,00 PLN</p>',	'<p>Dla najbardziej wymagających gości mamy do dyspozycji pok&oacute;j DE LUX. To przestronny pok&oacute;j dzienny z kącikiem wypoczynkowym, biurkiem i panoramicznym oknem oraz oddzielną sypialnią z łożem małżeńskim.</p>\r\n<p>W dużej, kamiennej łazience odnajdą Państwo wygodną wannę oraz luksusowe kosmetyki serii Un brin de nature.</p>\r\n<p>Pok&oacute;j wyposażony jest w szereg technologicznych udogodnień: indywidualnie sterowaną klimatyzację, telewizor plazmowy oraz bezpłatny, szybki internet Wi-Fi.</p>\r\n<p>Nasz pok&oacute;j DE LUX to luksus na kt&oacute;ry mogą Państwo sobie pozwolić.</p>',	1448838000,	1455021654,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj3.jpg',	'1451315184156814ff082321297197467.jpg'),
(4,	'Das Einzelzimmer',	'de_DE',	'<p>Preise: ab 209,00PLN</p>',	'<p>Unsere ger&auml;umigen Einzelzimmer bieten Ihnen ein breites und bequemes Bett, Satelitenfernsehen auf modernen Flachbildschirmen, kostenfreies W-LAN, regulierbare Klimaanlage und Annehmlichkeiten f&uuml;r unsere Gesch&auml;ftsreisende.</p>\r\n<p>Im komfortablen Badezimmer mit Steinboden finden Sie edle Toilettenartikel der renommierten Serie Un brin de natur.</p>',	1451516400,	1455614486,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj1.jpg',	'145155619315684fd6106ffd710358416.jpg'),
(5,	'Das Doppelzimmer',	'de_DE',	'<p>Preise: ab 219,00PLN</p>',	'<p>Wir stellen Ihnen unsere Doppelzimmer mit einem Doppelbett oder zwei separaten Einzelbetten zur Verf&uuml;gung. Alle B&ouml;den in den Doppelzimmer sind mit angenhmen, hypoallergenen Teppichb&ouml;den bedeckt und mit modernen Wenge-M&ouml;beln ausgestattet.</p>\r\n<p>In unseren Doppelzimmer bieten wir standardm&auml;&szlig;ig Satellitenfernsehen auf modernen Flachbildschirmen, regulierbare Klimaanlage und kostenfreies W-LAN. Im exklusiven Badezimmer mit Steinboden finden Sie edle Toilettenartikel&nbsp;der renommierten Serie Un brin de natur.</p>\r\n<p>Ein Zusatzbett f&uuml;r Kinder unter dem 16 Lebensjahr ist auf Kundenwunsch m&ouml;glich.</p>',	1451516400,	1455614515,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj2.jpg',	'145155633615684fdf060a5e435677052.jpg'),
(6,	'Das De Lux Zimmer',	'de_DE',	'<p>Preise: ab 299,00PLN</p>',	'<p>Wem Einzel- und Doppelzimmer nicht gen&uuml;gen, der kann in einem De Lux- Zimmer die Nacht verbringen. Das De Lux- Zimmer besteht aus einem gro&szlig;z&uuml;gigen Wohnzimmer mit einem sch&ouml;nen Sitzbereich, einem Schreibtisch, einem Panoramafenster und aus einem separaten Schlafzimmer mit gro&szlig;em Doppelbett.</p>\r\n<p>Im exklusiven Badezimmer mit Steinboden finden Sie eine komfortable Badewanne und edle <strong>Toilettenartikel </strong>Serie Un brin de natur. Das De Lux- Zimmer bietet jeden modermen Komfort: individuell regelbare <strong>Klimaanlage</strong>, Satellitenfernschen auf <strong>modernem </strong>Flachbildschirm, kostenfreies Highspeed W-LAN.</p>\r\n<p>Unser De Lux-Zimmer ist ein Luxus, den Sie sich leisten k&ouml;nnen.</p>',	1448924400,	1455614370,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj3.jpg',	'145155646115684fe6d6dfda221080319.jpg'),
(7,	'Single room',	'en_US',	'<p>Price: 209,00 PLN</p>',	'<p>This is a spacious room with a large, comfortable bed. In each room there is a posh, stone bathroom with Pascal Morabito Paris cosmetics.</p>\r\n<p>The rooms are equipped with plasma, satellite televison, air conditioning with individual control and internet wi-fi. For our business guestes there is comfortable place to work in each room.</p>',	1455145200,	1455021817,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj1.jpg',	'145155894415685082087c0d100993874.jpg'),
(8,	'Double room',	'en_US',	'<p>Price: 219,00PLN</p>',	'<p>We would like to offer comfortable double rooms with double bed or two single beds. In each room there is a posh, stone bathroom with Pascal Morabito Paris cosmetics, soft hypoallergic fitted carpet and trendy Wenge furniture.</p>\r\n<p>The is satellite television, air-conditioning and wi-fi in each room.</p>\r\n<p>We can also provide an extra child bed for childeren under 16 years old.</p>',	1451516400,	1455021827,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj2.jpg',	'1451558983156850847807c2750263658.jpg'),
(9,	'DE LUX room',	'en_US',	'<p>Price: 299,00PLN</p>',	'<p>For the most demanding guests we have a De Lux room. It is a spacious living room with a &lsquo;&rsquo;rest comer&rsquo;&rsquo;, a desk, panoramic window and a separate bedroom with double bed.</p>\r\n<p>In a big stone bathroom there is a comfortable bath and Pascal Morabito Paris cosmetics. There are many technical facilities like: air conditioning with individual control, plasma television, quick internet wi-fi (free of charge).</p>\r\n<p>Our De Lux room is a luxury room you can afford.</p>',	1448924400,	1455021859,	1,	0,	0,	NULL,	'',	'',	'',	'',	'pokoj3.jpg',	'14515590941568508b687c5d419192118.jpg');
...
(54,	'Restauracja',	'restauracja',	'pl_PL',	0,	1451292095,	1453184507,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	85,	1,	0,	'cms',	0,	NULL),
...
(63,	'Der Kaminraum',	'der-kaminraum',	'de_DE',	61,	1451553159,	1455613796,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	0,	1,	0,	'cms',	0,	NULL),
(64,	'Preise',	'preise',	'de_DE',	0,	1451553348,	0,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	90,	1,	0,	'cms',	0,	NULL),
(65,	'Restaurant',	'dasrestaurant',	'de_DE',	0,	1451553406,	1455003937,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	85,	1,	0,	'cms',	0,	NULL),
...
(68,	'Spezialangebot',	'spezialangebot',	'de_DE',	0,	1451553627,	1455614862,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	70,	1,	0,	'cms',	0,	NULL),
...
(74,	'Restaurant',	'restaurant',	'en_US',	0,	1451553911,	1455003979,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	85,	1,	0,	'cms',	0,	NULL),
(75,	'Garden',	'garden',	'en_US',	0,	1451553956,	1455804353,	'Y',	'',	'',	NULL,	NULL,	NULL,	'',	80,	1,	0,	'cms',	0,	NULL),
...
(54,	131,	201,	NULL,	NULL,	NULL),
(65,	132,	202,	NULL,	NULL,	NULL),
(65,	133,	203,	NULL,	NULL,	NULL),
(74,	134,	204,	NULL,	NULL,	NULL),
(74,	135,	205,	NULL,	NULL,	NULL);
...
(40,	'Cennik',	'<table style=\"height: 98px; width: 420px;\">\r\n<tbody>\r\n<tr style=\"height: 13px;\">\r\n<td style=\"height: 13px; width: 420px;\" colspan=\"2\"><strong>Pokoje</strong></td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px; width: 236px;\">&nbsp;</td>\r\n<td style=\"height: 10px; text-align: center; width: 184px;\">&nbsp;</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px; width: 236px;\">Pok&oacute;j 1 - osobowy</td>\r\n<td style=\"height: 10px; text-align: center; width: 184px;\">od 209,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px; width: 236px;\">Pok&oacute;j 2&nbsp;- osobowy</td>\r\n<td style=\"height: 10px; text-align: center; width: 184px;\">od 219,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px; width: 236px;\">Pok&oacute;j&nbsp;DE LUX</td>\r\n<td style=\"height: 10px; text-align: center; width: 184px;\">od 299,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px; width: 420px;\" colspan=\"2\">\r\n<p>&nbsp;</p>\r\n<p style=\"text-align: center;\"><strong><a href=\"kontakt\">Zapytaj o cenę weekendową</a></strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p>&nbsp;</p>\r\n<table>\r\n<tbody>\r\n<tr>\r\n<td>\r\n<p>Śniadanie 36 PLN</p>\r\n<p>Dostawka 50 PLN (dotyczy dzieci do 16 roku życia)</p>\r\n<p>Wynajem sali&nbsp;klubowej&nbsp;na wyłączność 50 PLN/h</p>\r\n<p>&nbsp; serwis kawowy 32 PLN/os</p>\r\n<p>Profesjonalna sala konferencyjna 50 PLN/h</p>\r\n<p>&nbsp; serwis kawowy 32 PLN/os</p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>',	90,	'Y'),
(41,	'Restauracja',	'<p><strong>Drodzy Goście,</strong></p>\r\n<p>&nbsp;</p>\r\n<p>Meg\'s Grill jest wynikiem moich wieloletnich marzeń oraz życiowej pasji, dlatego tak bardzo staram się dostarczyć Państwu niezapomnianych doznań w spokojnej atmosferze.</p>\r\n<p>W naszej restauracji zjedzą Państwo pyszne śniadanie, błyskawicznie zaserwowany lunch, a także klimatyczną kolację przygotowaną z najwyższej jakości produkt&oacute;w, kt&oacute;rych dostawę osobiście nadzoruję.&nbsp;</p>\r\n<p>Będzie mi niezmiernie miło Państwa gościć.</p>\r\n<p>&nbsp;</p>\r\n<p><strong>Zapraszam i życzę smacznego</strong></p>\r\n<p>- Magdalena Reszka</p>\r\n<p>&nbsp;</p>\r\n<p>Restauracja Meg\'s Grill serwuje świeże ryby, transportowane na łodzie prosto z portu w Hamburgu, mięsa od najlepszych handlowc&oacute;w z całego świata oraz zdrowe warzywa i aromatyczne zioła z plantacji BIO.</p>\r\n<p>&nbsp;</p>\r\n<p>Restauracja Meg\'s Grill, ul. Bukowska 348/350, 60-189 Poznań, tel. 61 868 24 00, &nbsp;501 166 200</p>',	91,	'Y'),
(42,	'Ogród',	'<p id=\"descTask5190867\" class=\"descTask\" data-bind=\"html:descAsHTML(),attr:{id:\'descTask\' + id}\">Nasz ogr&oacute;d to idealne miejsce, by w ciepły letni dzień odpocząć w cieniu parasola, z dala od zgiełku miasta, na łonie natury, wsłuchując się jedynie w przyjemny szum wody oraz śpiew ptak&oacute;w. <br /><br />W otoczeniu zieleni i zapachu kwiat&oacute;w mogą Państwo rozkoszować się chłodnym orzeźwiającym drinkiem. Jeśli tylko pogoda na to pozwoli, na Państwa życzenie zaserwujemy w ogrodzie śniadanie, lunch lub kolację. <br /><br />To także idealne miejsce, by przy świetle lampion&oacute;w i butelce dobrego wina spędzić letni wiecz&oacute;r.</p>',	92,	'Y'),
(43,	'Rezerwacje',	'<table>\r\n<tbody>\r\n<tr>\r\n<td>Pok&oacute;j 1 - osobowy</td>\r\n<td>209,00 PLN</td>\r\n</tr>\r\n<tr>\r\n<td>Pok&oacute;j 2&nbsp;- osobowy</td>\r\n<td>219,00 PLN</td>\r\n</tr>\r\n<tr>\r\n<td>Pok&oacute;j&nbsp;Deluxe</td>\r\n<td>299,00 PLN</td>\r\n</tr>\r\n</tbody>\r\n</table>',	93,	'Y'),
(44,	'Promocje',	'',	94,	'Y'),
(45,	'O nas',	'<p>Comm hotel położony jest&nbsp; zaledwie <strong>100 metr&oacute;w</strong> od Portu Lotniczego Ławica tworząc idealne położenie niezależnie od tego czy przybędziecie Państwo do naszego czarującego miasta samolotem, pociągiem czy samochodem. Dotarcie do portu lotniczego to jedynie dwie minuty przyjemnego spaceru, a dojazd do centrum miasta oraz Międzynarodowych Targ&oacute;w Poznańskich nie zajmie Państwu więcej niż 15 minut.</p>\r\n<p>&nbsp;</p>\r\n<p>Nasze pokoje gościnne są specjalnie zaprojektowane, odnajdą tu Państwo najbardziej ekskluzywne połączenie designu, funkcjonalności i najnowszej technologii.</p>\r\n<p>&nbsp;</p>\r\n<p>Nasz hotel słynie z wyśmienitej kuchni, kt&oacute;ra sprosta nawet najbardziej wymagającym smakoszom.</p>\r\n<p>Zapraszamy na wykwintny bufet śniadaniowy, kt&oacute;ry jest gwarancją dnia pełnego sukces&oacute;w. Oferujemy szeroką gamę r&oacute;żnorodnych dań: świeże owoce i ważywa, najwyższej jakości wędliny i sery.&nbsp;Potrawy gorące &ndash; na przykład jajka przyrządzone na&nbsp;spos&oacute;b jaki najbardziej Państwo lubią, omlety z ciekawymi dodatkami, gorące kiełbaski lub plastry wędzonego łososia. Wszystko to dopełnia wyśmienity sok wyciskany na oczach Gości ze świeżych hiszpańskich pomarańczy lub gorąca kawa, kt&oacute;rej aromat już o poranku unosi się w całym hotelu.</p>\r\n<p>&nbsp;</p>\r\n<p>Profesjonalny serwis oraz niespotykana, rodzinna atmosfera sprawią, że niezależne od celu podr&oacute;ży pobyt w naszym&nbsp;hotelu stanie się niezapomniany.</p>',	96,	'Y'),
...
(47,	'Sala klubowa',	'<p>Stworzona z myślą by umilić Państwu czas sala klubowa wyposażona jest w profesjonalny st&oacute;ł bilardowy, dart, &nbsp;telewizor plazmowy oraz wygodne fotele.</p>\r\n<p>To idealne miejsce, by zrelaksować się po lub przed podr&oacute;żą. Zlokalizowana na uboczu zapewnia prywatność a ogień w kominku tworzy niezapomniany klimat.</p>\r\n<p>Obsługa chętnie poda Państwu drinka lub aromatyczne cygaro, sala jest bowiem przystosowana dla os&oacute;b palących.</p>',	100,	'Y'),
(48,	'Uber uns',	'<p>Die unmittelbar N&auml;he des Comm-Hotels vom Flughafen Poznań-Ławica (nur 100 Meter) gew&auml;hrleistet unseren G&auml;sten eine optimale Lage- unabh&auml;ngig davon, ob Sie mit dem Flugzeug, mit dem Zug oder mit dem Auto unsere bezaubernde Stadt anreisen. Den Flughafen Poznań-Ławica erreichen Sie zu Fu&szlig; in nur zwei Minuten, das Stadtzentrum und die Posener Messe (MTO) erreichen Sie in weniger als 15 Minuten. Die Inneneinrichtung unserer Zimmer wurde speziell gestaltet, damit Sie hier eine exklusive Mischung aus Design, Funktionalit&auml;t und allerneuster Technologie finden.</p>\r\n<p>Genie&szlig;en Sie unser vorz&uuml;gliches Fr&uuml;hst&uuml;cksbuffet-es garantiert Ihnen einen erfolgreichen Tag! Wir&nbsp;bieten eine Vielfalt von verschiedenen Speisen: friches Obst und Gem&uuml;se, Aufschnitt und K&auml;sesorten von h&ouml;chster Qualit&auml;t. Warme Speisen wie Eier, die f&uuml;r unsere G&auml;ste auf beliebige Art und Weise zubereitet werden, Omelette mit phantasievollen Zutaten, warme W&uuml;rstchen oder ger&auml;ucherte Scheiben vom Lachs. Ein frisch gepresster Orangensaft oder eine Tasse hei&szlig;en Kaffees, dessen aromatischer Duft sich gegen Morgen im ganzen Hotel verbreitet, runden das k&ouml;stliche Fr&uuml;hst&uuml;ck ab.</p>\r\n<p>Dank unserem professionellen Service und dem einmaligen famili&auml;ren Ambiente wird der Aufenthalt in unserem Hotel, unabh&auml;ngig von Ihrem Reiseziel, zum unvergesslichen Erlebnis.</p>',	104,	'Y'),
(49,	'Das Hotel',	'',	105,	'Y'),
(50,	'Der Kaminraum',	'<p>Damit unsere G&auml;ste sich nach oder von der Reise entspannen k&ouml;nnen, stellen wir Ihnen einen abseits gelegenen Unterhaltungsraum zur Verf&uuml;gung.</p>\r\n<p>Sie k&ouml;nnen sich hier in einen bequemen Sessel zur&uuml;cklehnen und eine aromatische Zigarre in Brand stecken oder einfach vor dem Kamin sitzen und Ihren Drink genie&szlig;en. Das Hotel macht seinen G&auml;sten einen professionellen Billardtisch, Darts, Satellitenfernsehen auf modernem Flaschbilschirm und bequeme Sessel verf&uuml;gbar.</p>\r\n<p>Unser Unterhaltungsraum als ein idealer Ort f&uuml;r entspannte Stunden am Abend sorgt es f&uuml;r das Wohlbefinden unserer G&auml;ste und das Kaminfeuer schafft eine einmaliege Atmosph&auml;re.</p>',	107,	'Y'),
(51,	'Preise',	'<table style=\"height: 98px;\" width=\"436\">\r\n<tbody>\r\n<tr style=\"height: 13px;\">\r\n<td style=\"height: 13px;\" colspan=\"2\"><strong>Zimmer</strong></td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">&nbsp;</td>\r\n<td style=\"height: 10px; text-align: center;\">&nbsp;</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">Das Einzelzimmer</td>\r\n<td style=\"height: 10px; text-align: center;\">ab&nbsp;209,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">Das Doppelzimmer</td>\r\n<td style=\"height: 10px; text-align: center;\">ab&nbsp;219,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">Das DE LUX-Zimmer</td>\r\n<td style=\"height: 10px; text-align: center;\">ab&nbsp;299,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\" colspan=\"2\">\r\n<p>&nbsp;</p>\r\n<p style=\"text-align: center;\"><strong><a href=\"kontakt-69\" rel=\"prettyPhoto\">Preise am Wochenende</a></strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p>&nbsp;</p>\r\n<table>\r\n<tbody>\r\n<tr>\r\n<td>\r\n<p>Das Fr&uuml;hst&uuml;ck 36 PLN</p>\r\n<p>Zustellbett 50 PLN (nur f&uuml;r Kinder&nbsp; unter 16 Lebensjahr)</p>\r\n<p>Rent exklusive Kamin salle 50 PLN/h</p>\r\n<p>&nbsp; coffie service 32 PLN/person</p>\r\n<p>Profesional Konfferenc salle 50 PLN/h</p>\r\n<p>&nbsp; coffie service 32 PLN/person</p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>',	108,	'Y'),
...
(60,	'Price list',	'<table style=\"height: 98px;\" width=\"436\">\r\n<tbody>\r\n<tr style=\"height: 13px;\">\r\n<td style=\"height: 13px;\" colspan=\"2\"><strong>Rooms</strong></td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">&nbsp;</td>\r\n<td style=\"height: 10px; text-align: center;\">&nbsp;</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">Single room</td>\r\n<td style=\"height: 10px; text-align: center;\">from&nbsp;209,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">Double room</td>\r\n<td style=\"height: 10px; text-align: center;\">from 219,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\">DE LUX room</td>\r\n<td style=\"height: 10px; text-align: center;\">from&nbsp;299,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 10px;\">\r\n<td style=\"height: 10px;\" colspan=\"2\">\r\n<p>&nbsp;</p>\r\n<p style=\"text-align: center;\"><strong><a href=\"contact\">Ask for weekend prices</a></strong></p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>\r\n<p>&nbsp;</p>\r\n<table>\r\n<tbody>\r\n<tr>\r\n<td>\r\n<p>Breakfast&nbsp;36 PLN</p>\r\n<p>Denture 50 PLN (for children up to 16 years old)</p>\r\n<p>Rent exclusive fireplace salle 50 PLN/h</p>\r\n<p>&nbsp; &nbsp;coffee service 32 PLN/person</p>\r\n<p>Professional Conference room 50 PLN/h</p>\r\n<p>&nbsp; &nbsp;coffee service 32PLN/person</p>\r\n</td>\r\n</tr>\r\n</tbody>\r\n</table>',	119,	'Y'),
...
(63,	'Reservierung',	'<table>\r\n<tbody>\r\n<tr>\r\n<td>Das Einzelzimmer</td>\r\n<td>ab 209,00 PLN</td>\r\n</tr>\r\n<tr>\r\n<td>Das Doppelzimmer</td>\r\n<td>ab 219,00 PLN</td>\r\n</tr>\r\n<tr>\r\n<td>Das Deluxe&nbsp;Zimmer</td>\r\n<td>ab 299,00 PLN</td>\r\n</tr>\r\n</tbody>\r\n</table>',	129,	'Y'),
(64,	'Reservation',	'<table>\r\n<tbody>\r\n<tr style=\"height: 13px;\">\r\n<td style=\"height: 13px;\">Single room</td>\r\n<td style=\"height: 13px;\">209,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 13px;\">\r\n<td style=\"height: 13px;\">Double room</td>\r\n<td style=\"height: 13px;\">219,00 PLN</td>\r\n</tr>\r\n<tr style=\"height: 13px;\">\r\n<td style=\"height: 13px;\">Deluxe&nbsp;room</td>\r\n<td style=\"height: 13px;\">299,00 PLN</td>\r\n</tr>\r\n</tbody>\r\n</table>',	130,	'Y'),
(65,	'Restaurant',	'<p><em>Liebe G&auml;ste,</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>MEG\'S Grill ist Passion und Tr&auml;ume meines Lebens, deshalb gebe ich mich alle M&uuml;he schmackhafte und vielf&auml;ltige Gerichte in ruhiger, entspannter Ambiente zu servieren.</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>In unserem Restaurant geniessen Sie frischvorbereitetes Fr&uuml;hst&uuml;ck, gesundes Mittagessen, das schnell serviert wird und zum Abschluss des Tages ein leckeres Abendessen.</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>Alle Speisen sind aus Produkte von h&ouml;chster Qualit&auml;t zubereitet, deren Lieferungen beaufsichtige ich selbst.</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>Herzlich willkommen und guten Appetit</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>Magdalena Reszka</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p>Restaurant MEG\'S Grill serviert frische Fische, die gerade vom Hamburger Hafen geleifert sind, Fleisch von den besten Produzenten der Welt, gesunde Gem&uuml;se und aromatische BIO Kr&auml;uter.</p>\r\n<p>&nbsp;</p>\r\n<p>MEG\'S Grill &amp; Restaurant, ul. Bukowska 348/350, 60-189 Poznań, tel. +48 61 868 24 00, +48 501 166 200</p>',	132,	'Y'),
(66,	'Restaurant',	'<p><em>Dear Guests,</em></p>\r\n<p>&nbsp;</p>\r\n<p><em>MEG\'S Grill is the result of my life dreams and passions, that is why I always try to provide You with an unforgettable culinary experience in a quiet, homely atmosphere.</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>In our restaurant You can enjoy a delicious breakfast, quick lunch and lovely dinner prepared from highest quality products, delivery of which I personally supervise.</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>I\'ll be pleased to welcome you at MEG\'S and wish you bon app&eacute;tit.</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p><em>Magdalena Reszka</em></p>\r\n<p><em>&nbsp;</em></p>\r\n<p>MEG\'S Grill &amp; Restaurant serves fresh fish, transported on ice straight from the port in Hamburg, meats from best breeders from all over the world, as well as healthy vegetables and aromatic herbs from BIO Plantations.</p>\r\n<p>&nbsp;</p>\r\n<p>MEG\'S Grill &amp; Restaurant, ul. Bukowska 348/350, 60-189 Poznań, tel. +48 61 868 24 00, +48 501 166 200</p>',	134,	'Y');
