<div id="admin_product_edit">
    ...
    <div id="product_edit_title">
        <h2><?php echo Kohana::lang('product.edit_product') . ' - ' . $oProductDetails[0]->product_name; ?></h2>
    </div>
    <div id="admin_edit_product">
        ...
        $aTabTitles = array(
            ...
            Kohana::lang('product.related_products'), //11
            Kohana::lang('product.product_adaptations'), //12
            Kohana::lang('product.product_projection'), //13
            Kohana::lang('product.product_marks')); //14
        $iTabTitlesCount = count($aTabTitles);
        for($i = 0 ; $i <= $iTabTitlesCount - 1 ; $i++):
            if(in_array($i, array(3, 4, 6, 7, 8, 9, 12, 13, 14))) { continue; } // pomijamy zakładkę wartianty produktu i komentarze i pliki
        ?>
        ...
        <div id="tabs-1" class="ui-tabs-hide">
            ...
            <table class="table_form">
                <tr>
                    ...
                    <td style="position: relative;">
                        <input type="text" name="product_name" id="product_name" value="<?php if(!empty($_POST['product_name'])) {echo $_POST['product_name'];} elseif(!empty($oProductDetails[0]->product_name)) { echo $oProductDetails[0]->product_name;} else { echo '';} ?>" />
                        <?php echo languages::ShowTranslationBox('product', $oProductDetails[0]->id_product, 'input');?>
                        <?php /*
                        <ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_name_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul> */ ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="product_name_en" id="product_name" value="<?php if(!empty($_POST['product_name_en'])) {echo $_POST['product_name_en'];} elseif(!empty($oProductDetails[1]->product_name)) { echo $oProductDetails[1]->product_name;} else { echo '';} ?>" />                        
                    </td>
                    <td><div id="product_name_error" class="error_message"></div></td>
                </tr> */ ?>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="price" id="price" onchange="javascript:countPrice();" value="<?php if(!empty($_POST['price'])) {echo $_POST['price'];} elseif(!empty($oProductDetails[0]->price)) { echo $oProductDetails[0]->price;} else { echo '';} ?>" />
                        <input type="hidden" name="tax_id" id="tax_id" value="">
                        <!--
                        <select name="tax_id" id="tax_id" onchange="javascript:countPrice();">
                            <?php $tmpTaxId = 0; if(!empty($_POST['tax_id'])) {$tmpTaxId = $_POST['tax_id'];} elseif(!empty($oProductDetails[0]->tax_id)) { $tmpTaxId = $oProductDetails[0]->tax_id;} else { $tmpTaxId = 0;} ?>
                            <?php foreach($oTaxes as $t): ?>
                            <?php if(!empty($oProductDetails[0]->tax_id) && $t->tax_value == $oProductDetails[0]->tax_id): ?>
                ...
                <tr>
                    ...
                    <td><input type="text" name="code" id="code" value="<?php if(!empty($_POST['code'])) {echo $_POST['code'];} else { echo $oProductDetails[0]->code;} ?>" /></td>
                ...
                <tr>
                    ...
                    <td>
                        <select id="producer_id" name="producer_id">
                            <?php $tmpProducerId = 0; if(!empty($_POST['producer_id'])) {$tmpProducerId = $_POST['producer_id'];} elseif(!empty($oProductDetails[0]->producer_id)) { $tmpProducerId = $oProductDetails[0]->producer_id;} else { $tmpProducerId = 0;} ?>
                ...
                <tr>
                    ...
                    <td>
                        <select id="active" name="active">
                            <option value="Y"<?php if(!empty($_POST['active']) && $_POST['active'] == 'Y') { echo ' selected="selected"'; } elseif(!empty($oProductDetails[0]->product_active) && $oProductDetails[0]->product_active == 'Y') { echo ' selected="selected"'; } ?>><?php echo Kohana::lang('product.available'); ?></option>
                            <option value="N"<?php if(!empty($_POST['active']) && $_POST['active'] == 'N') { echo ' selected="selected"'; } elseif(!empty($oProductDetails[0]->product_active) && $oProductDetails[0]->product_active == 'N') { echo ' selected="selected"'; } ?>><?php echo Kohana::lang('product.unavailable'); ?></option>
                        </select>
                    </td>
            ...
            <td><input type="text" name="product_position" id="product_position" value="<?php if(!empty($_POST['product_position'])) {echo $_POST['product_position'];} else { echo $oProductDetails[0]->product_position;} ?>" /></td>
                ...
                <tr>
                    ...
                    <td>
                        <select name="product_status_id" id="product_status_id">
                            <?php $tmpStatusId = 0; if(!empty($_POST['product_status_id'])) {$tmpStatusId = $_POST['product_status_id'];} elseif(!empty($oProductDetails[0]->product_status_id)) { $tmpStatusId = $oProductDetails[0]->product_status_id;} else { $tmpStatusId = 0;} ?>
        ...
        <div id="tabs-2" class="ui-tabs-hide">
            ...
            <table class="table_form">                
                <tr>
                    ...
                    <td>
                        <textarea name="short_description" id="short_description" rows="5" cols="60"><?php if(!empty($POST['short_description'])) {echo $POST['short_description']; } elseif(!empty($oProductDetails[0]->product_short_description)) { echo $oProductDetails[0]->product_short_description; } else { echo '';} ?></textarea>
                        <?php /*
                        <ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_short_description_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul> */ ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="short_description_en" id="short_description_en" rows="5" cols="60"><?php if(!empty($POST['short_description_en'])) {echo $POST['short_description_en']; } elseif(!empty($oProductDetails[1]->product_short_description)) { echo $oProductDetails[1]->product_short_description; } else { echo '';} ?></textarea>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="description" id="description" rows="5" cols="60"><?php if(!empty($_POST['product_description'])) { echo $_POST['product_description']; } elseif(!empty($oProductDetails[0]->product_description)) { echo $oProductDetails[0]->product_description; } else {echo '';} ?></textarea>
                        <?php /*<ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_description_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul> */ ?>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="description_en" id="description_en" rows="5" cols="60"><?php if(!empty($_POST['product_description_en'])) { echo $_POST['product_description_en']; } elseif(!empty($oProductDetails[1]->product_description)) { echo $oProductDetails[1]->product_description; } else {echo '';} ?></textarea>                        
                    </td>
                    <td><div id="description_error" class="error_message"></div></td>
                </tr>                 
                 */ ?>
				<tr>
                    ...
                    <td>
                        <textarea name="product_media" id="product_media" rows="5" cols="60"><?php if(!empty($_POST['product_media'])) { echo $_POST['product_media']; } elseif(!empty($oProductDetails[0]->product_media)) { echo $oProductDetails[0]->product_media; } else {echo '';} ?></textarea>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="guarantee" id="guarantee" rows="5" cols="60"><?php if(!empty($POST['guarantee'])) {echo $POST['guarantee']; } elseif(!empty($oProductDetails[0]->product_guarantee)) { echo $oProductDetails[0]->product_guarantee; } else { echo '';} ?></textarea>
                        <ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_guarantee_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul>
                    </td>
                    <td><div id="short_description_error" class="error_message"></div></td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
							<td>
                            <?php //start ?>
                            <?php /* echo Kohana::debug( $oParametersValues[$p->parameter_id] );?>
                            <?php if (count($oParametersValues[$p->parameter_id]['parameter_value'])>=1 &&
                                ...
                                <?php
                                    ...
                                    if(in_array($p->id_parameter, array_keys($aProductParameters))) {
                                        for($i=0; $i<count($oParametersValues[$p->parameter_id]['id_parameter_value']); i++){
                                            if ($aProductParameters[$p->id_parameter] === $oParametersValues[$p->parameter_id]['id_parameter_value'][$i])
                                             todo: 
                                        }
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="estimate" id="estimate" rows="5" cols="60"><?php if(!empty($_POST['estimate'])) {echo $_POST['esitmate']; } elseif(!empty($oProductDetails[0]->estimate)) { echo $oProductDetails[0]->estimate; } else {echo '';} ?></textarea>
                    </td>
                    <td><div id="description_error" class="error_message"></div></td>
                </tr>
                -->
            ...
            <table class="table_form">
                <tr>
                    <td class="td_form_left">
                        ...
                        Zdjęcie główne produktu: 360px x 411px
        ...
        <?php /*
        <div id="tabs-15" class="ui-tabs-hide">
            <?php 
                //var_dump($oMarks);
            //var_dump($oProductMarks);
            echo form::open_multipart(null, array('method' => 'post', 'onsubmit' => "javascript: return requestAjax();")); ?>
            <table>
                <tr>
                    <td class="td_form_left td_form_top">
                        <label for="attributes"><?php echo Kohana::lang('product.attributes'); ?></label>
                    ...
                    <td>
                        ...
                        <?php
                        $aProductMarks=array();
                        foreach($oProductMarks as $pm) :
                            $aProductMarks[]=$pm->media_id;
                        endforeach;
                        $i=1;                        
                        foreach($oMarks as $m): ?>
                        <tr>
                            <td>
                            <?php if(in_array($m->id_media, $aProductMarks)) : ?>
                                <input type="checkbox" name="mark[]" value="<?php echo $m->id_media; ?>" checked="checked" />
                            <?php else : ?>
                                <input type="checkbox" name="mark[]" value="<?php echo $m->id_media; ?>" />
                            <?php endif; ?>
                            </td>                            
                            <td><?php echo (file_exists(media_helper::IMAGE_SMALL_PATH.$m->file_name) ? html::image(media_helper::IMAGE_SMALL_PATH.$m->file_name, array('alt'=>$m->media_description)) : ''); ?></td>
                        </tr>
                        <?php
                        $i++;
                        endforeach;
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td><input type="hidden" name="submit_tab" value="submit_tab_15" /><input type="submit" name="submit" value="<?php echo Kohana::lang('product.save'); ?>" class="ui-button ui-widget ui-state-default ui-corner-all"  /></td>
                    <td>&nbsp;</td>
                </tr>
            </table>
            <?php echo form::close(); ?>
        ...
        <div id="tabs-10" class="ui-tabs-hide">
            ...
            <table class="table_form">
                <tr>
                    ...
                    <td>
                        <input type="text" name="meta_title" id="meta_title" value="<?php if(!empty($oProductDetails[0]->meta_title)) {echo $oProductDetails[0]->meta_title;}; ?>" style="width: 300px;" />
                        <ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_meta_title_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="meta_description" id="meta_description" value="<?php if(!empty($oProductDetails[0]->meta_description)) { echo $oProductDetails[0]->meta_description; } ?>" style="width: 300px;" />
                        <ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_meta_description_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="meta_keywords" id="meta_keywords" value="<?php if(!empty($oProductDetails[0]->meta_keywords)) { echo $oProductDetails[0]->meta_keywords; } ?>" style="width: 300px;" />
                        <ul class="os-languages-list">
                        <?php foreach($oLanguages as $lang): ?>
                            <li><span onclick="javascript:showI18nDialog('product_meta_keywords_language_dialog', <?php echo $lang->id_language; ?>, <?php echo $oProductDetails[0]->id_product; ?>);"><?php echo Kohana::lang('language.' . $lang->description); ?></span></li>
                        <?php endforeach; ?>
                        </ul>
                    </td>
        ...
        <div id="tabs-11" class="ui-tabs-hide">
            ...
            <table class="table_form">
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="recommend" id="recommend"<?php if(!empty($oProductDetails[0]->recommend) && $oProductDetails[0]->recommend == 'Y'){echo ' checked="checked"';} ?> />
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <input type="checkbox" name="bestseller" id="bestseller"<?php if(!empty($oProductDetails[0]->bestseller)&&$oProductDetails[0]->bestseller == 'Y'){ echo ' checked="checked"';} ?> />
                    </td>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="new" id="new"<?php if(!empty($oProductDetails[0]->new)&&$oProductDetails[0]->new=='Y'){echo ' checked="checked"';} ?> /></td>
                    <td><div id="new_error" class="error_message"></div></td>
                </tr>
                <tr>
                    <td class="td_form_left">
                    ...
                    <td>
                        <input type="text" name="old_price" id="old_price" value="<?php if(!empty($oProductDetails[0]->old_price) && $oProductDetails[0]->old_price) {echo html::specialchars($oProductDetails[0]->old_price);} ?>" />
                    </td>
