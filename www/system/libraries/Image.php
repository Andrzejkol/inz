...
class Image_Core {
	...
	protected function valid_size($type, & $value)
	{
        ...
        /**
* Creates watermark on image using other image.
 *
* @param Image $image Watermark image object.
* @param integer $transparency Watermark transparency level <0, 100>.
* @param integer $left Left coordinate.
* @param integer $top Top coordinate.
* @return Image Current object instance.
* @author phpion
 */
